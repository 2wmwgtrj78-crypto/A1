...
var DEFAULTS = {
  /* One day model. 9 h 15 m of study is the Normal day; Empathy is the same day
     ...
     tiers are gone. The campaign starts 22 September 2026, a Tuesday, with an
     ...
     Content begins Wednesday 23 Sep, and the first rampDays content days are
     SOFT (one slot instead of two), so week one is genuinely lighter and the
     campaign extends forward to absorb it rather than running a deficit.
     v16.5: moved from 20 Sep to 22 Sep \u2014 the person actually starting
     tomorrow, for real, rather than another hypothetical date. */
  ...
  diagnosticDays: 14,
  startISO: "2026-09-22", hardStartISO: null, correctEvery: 14,
